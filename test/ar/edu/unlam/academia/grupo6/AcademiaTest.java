...
public class AcademiaTest {
	...
	public void queSePuedaAgregarUnaClaseExtraDeUnCursoAUnAlumnoEnLaAcademia() {
		...
		Academia DonRipRip = new Academia(nombreDeLaAcademia);
		Curso manejoInicial = new Curso(codigoCurso, tipoDeCurso, duracionCurso, valorCuota);
		Alumno nuevoAlumno = new Alumno(legajo, dni, nombre, celular, email, direccion, fechaDelInscripcion,
				fechaDelFinalizacion, estado);
		...
		Integer agregarClaseExtraAlCurso = nuevoAlumno.agregarUnaClaseExtraDeUnCursoDeUnAlumnoAUnaAcademia(codigoCurso,
				cantidadDeClasesExtra, legajo);
		// VALIDACION
	...
	public void queSePuedaCambiarElValorDeLaCuotaDelCurso() {
		...
		Academia DonRipRip = new Academia(nombreDeLaAcademia);
		Boolean sePudo = DonRipRip.IngrasarCursoEnLaAcademia(manejoInical);
		Curso seCambioElValorDeLaCuotaDelCurso = DonRipRip.CambiarElValorDeLaCuotaDelCurso(codigoCurso,
				nuevoValorCuota);
...
//PREPARACION 
		...
		Alumno Lashir = new Alumno(legajoDos, dniDeDos, nombreDeDos, celularDeDos, emailDeDos, direccionDeDos,
				fechaDelInscripcionDeDos, fechaDelFinalizacionDeDos, estadoDeDos);
		Alumno Menganito = new Alumno(legajoTres, dniDeTres, nombreDeTres, celularDeTres, emailDeTres, direccionDeTres,
				fechaDelInscripcionDeTres, fechaDelFinalizacionDeTres, estadoDeTres);
		Alumno Liciada = new Alumno(legajoCuatro, dniDeCuatro, nombreDeCuatro, celularDeCuatro, emailDeCuatro,
				direccionDeCuatro, fechaDelInscripcionDeCuatro, fechaDelFinalizacionDeCuatro, estadoDeCuatro);
